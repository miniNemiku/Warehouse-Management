...
class Order {
    ...
    public:
        ...
        const string volun_helper(int volun_status) const;
        const string status_helper(OrderStatus status) const;
        const string toString() const;
        bool getNeedTransfer();
        void switchNeedTransfer(bool transferStatus);
